...
const POS_2_CONFIG: PosScreenUIConfig = {
    ...
    header: {
        ...
        storeDropdownClass: 'appearance-none pl-2 pr-6 py-1.5 sm:pl-3 sm:pr-8 sm:py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md text-xs sm:text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400',
    ...
    layout: {
        ...
        orderSidebarClass: 'relative flex-shrink-0 w-full lg:w-[420px] xl:w-[480px] 2xl:w-[490px] h-[40vh] lg:h-full bg-white dark:bg-gray-800 border-t lg:border-t-0 lg:border-l border-gray-200 dark:border-gray-700',
    },
    mobile: {
...
const POS_1_CONFIG: PosScreenUIConfig = {
    ...
    header: {
        ...
        storeDropdownClass: 'px-2 py-2 bg-white dark:bg-slate-800 rounded-md text-base font-medium border border-slate-300 dark:border-slate-600 focus:outline-none focus:ring-1 focus:ring-primary text-gray-800 dark:text-white',
        mobileMenuButtonClass: 'lg:hidden p-2 sm:p-2.5 rounded-lg hover:bg-gray-100 touch-manipulation',
        showMobileMenuButton: true,
        rightSideContainerClass: 'flex items-center space-x-2 sm:space-x-3 flex-1 max-w-md sm:max-w-lg lg:max-w-xl justify-end',
...
const POS_3_CONFIG: PosScreenUIConfig = {
    ...
    header: {
        ...
        dateTimeTextClass: 'text-white font-semibold',
        storeDropdownClass: 'pl-3 pr-8 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-600 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none',
        mobileMenuButtonClass: 'lg:hidden p-1.5 sm:p-2 rounded-lg touch-manipulation hover:bg-gray-100',
        showMobileMenuButton: false,
        rightSideContainerClass: 'flex items-center flex-1 justify-end space-x-1 sm:space-x-1 md:space-x-2',
...
const POS_4_CONFIG: PosScreenUIConfig = {
    ...
    mobile: {
        ...
        categoryDrawerHeaderClass: 'flex items-center justify-between mb-4',
        orderDrawerClass: 'lg:hidden fixed inset-0 bg-black bg-opacity-50 z-50',
        orderDrawerHeaderClass: 'flex items-center justify-between mb-4',
    },
    bottomActionBar: {
        show: false,
        wrapperClass: '',
...
const POS_5_CONFIG: PosScreenUIConfig = {
    ...
    header: {
        ...
        showDarkModeToggle: true,
        showCartButton: false,
        cartButtonClass: 'p-1.5 sm:p-2 md:p-2.5 bg-primary dark:bg-gray-600 text-white rounded-md hover:bg-primaryHover',
        cartBadgeClass: '', // Hidden badge for POS_5
    },
    categorySidebar: {
    ...
    mobile: {
        ...
        orderDrawerClass: 'fixed inset-0 z-50 bg-black/40 xl:hidden',
        orderDrawerHeaderClass: 'flex items-center justify-between px-2 sm:px-3 py-2 border-b',
    },
    bottomActionBar: {
        show: true,
        wrapperClass: 'bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-1 sm:p-2 md:p-3 lg:p-4 xl:p-5',
