...
const DEFAULT_CONFIG: PosHeaderConfig = {
  ...
  showSearchBar: true,
  headerButtonClass: 'p-2 rounded-md bg-slate-700 dark:bg-slate-600 hover:bg-slate-800 dark:hover:bg-slate-500',
    ...
    <header className={config.wrapperClass}>
      <div className={config.innerContainerClass}>
        ...
        <div className="flex items-center gap-4 flex-1">
          ...
          <div className={config.welcomeTextClass}>
        ...
        <div className={config.rightSideContainerClass}>
          ...
          <button className={config.headerButtonClass} title={`Register: ${registerInfo.id}`}>
          ...
          <button onClick={onToggleFullscreen} className={config.headerButtonClass} title={isFullscreen ? 'Exit Fullscreen' : 'Fullscreen'}>
            {isFullscreen ? (
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5">
