...
export async function createHeroSectionAction(data: {
  ...
  try {
    ...
    if (data.sublist1 !== undefined) formData.append('sublist1', data.sublist1);
    if (data.sublist2 !== undefined) formData.append('sublist2', data.sublist2);
    if (data.sublist3 !== undefined) formData.append('sublist3', data.sublist3);
    if (data.sublist4 !== undefined) formData.append('sublist4', data.sublist4);
...
// Purchase Return: get invoice data (full DTO)
export async function getPurchaseReturnInvoiceDataAction(id: string) {
  try {
    const response = await ssrPurchaseReturnAPI.downloadInvoice(id);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to fetch purchase return invoice data' };
  } catch (error) {
    console.error('Get purchase return invoice data error:', error);
    return { success: false, error: 'Failed to fetch purchase return invoice data' };
  }
}
...
//SMS Template: create
export async function createSMSTemplateAction(data: Record<string, unknown>) {
  try {
    const response = await ssrSMSTemplateAPI.create(data);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
...
// SMS Template: update
export async function updateSMSTemplateAction(id: string, data: Record<string, unknown>) {
  try {
    const response = await ssrSMSTemplateAPI.update(id, data);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to update mail template' };
...
// SMS Template: delete
export async function deleteSMSTemplateAction(id: string) {
  try {
    const response = await ssrSMSTemplateAPI.delete(id);
    if (response.status === 200 || response.status === 204) {
      return { success: true };
    }
    return { success: false, error: 'Failed to delete mail template' };
...
//SMS Template : toggle status
export async function toggleSMSTemplateStatusAction(id: string) {
  try {
    const response = await ssrSMSTemplateAPI.toggleStatus(id);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to toggle mail template status' };
...
// Tenant SMS Settings Server Action

// Create or Update Tenant SMS Settings
export async function createOrUpdateTenantSmsSettingAction(data: {
  accountSid: string;
  authToken: string;
  phoneNumber: string;
  isVerified: boolean;
  ...
  try {
    const response = await ssrTenantSmsSettingAPI.createOrUpdate(data);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to save mail settings' };
...
// Verify Tenant SMS Settings
export async function verifyTenantSmsSettingAction() {
  try {
    const response = await ssrTenantSmsSettingAPI.verify();
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to verify mail settings' };
...
// Delete Tenant SMS Settings
export async function deleteTenantSmsSettingAction() {
  try {
    const response = await ssrTenantSmsSettingAPI.delete();
    if (response.status === 200 || response.status === 201 || response.status === 204) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to delete mail settings' };
...
// Tenant Whatsapp Settings Server Action


//Whatsapp Template: create
export async function createWhatsAppTemplateAction(data: Record<string, unknown>) {
  try {
    const response = await ssrWhatsAppTemplateAPI.create(data);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to create sms template' };
...
// SMS Template: update
export async function updateWhatsAppTemplateAction(id: string, data: Record<string, unknown>) {
  try {
    const response = await ssrWhatsAppTemplateAPI.update(id, data);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to update mail template' };
...
export async function deleteWhatsAppTemplateAction(id: string) {
  try {
    const response = await ssrWhatsAppTemplateAPI.delete(id);
    if (response.status === 200 || response.status === 204) {
      return { success: true };
    }
    return { success: false, error: 'Failed to delete mail template' };
...
//SMS Template : toggle status
export async function toggleWhatsAppTemplateStatusAction(id: string) {
  try {
    const response = await ssrWhatsAppTemplateAPI.toggleStatus(id);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to toggle mail template status' };
...
// Tenant WhatsApp Setting: create or update
export async function createOrUpdateTenantWhatsappSettingAction(data: {
  accountSid: string;
  authToken: string;
  phoneNumber: string;
  isVerified: boolean;
  ...
  try {
    const response = await ssrTenantWhatsAppSettingAPI.createOrUpdate(data);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to save WhatsApp settings' };
  } catch (error) {
    console.error('Create or update WhatsApp settings error:', error);
    return { success: false, error: 'Failed to save WhatsApp settings' };
  }
}

// Tenant WhatsApp Setting: verify
export async function verifyTenantWhatsappSettingAction() {
  try {
    const response = await ssrTenantWhatsAppSettingAPI.verify();
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to verify WhatsApp settings' };
  } catch (error) {
    console.error('Verify WhatsApp settings error:', error);
    return { success: false, error: 'Failed to verify WhatsApp settings' };
  }
}

// Tenant WhatsApp Setting: delete
export async function deleteTenantWhatsappSettingAction() {
  try {
    const response = await ssrTenantWhatsAppSettingAPI.delete();
    if (response.status === 200 || response.status === 204) {
      return { success: true };
    }
    return { success: false, error: 'Failed to delete WhatsApp settings' };
  } catch (error) {
...
export async function getPurchaseOrderInvoiceAction(id: string) {
  try {
    ...
    if (invResponse.status === 200 || invResponse.status === 201) {
      const pData = invResponse.data?.data;
      if (!pData) {
        return { success: false, error: 'No invoice data found' };
      }
      // Inject invoiceType so mapper knows how to handle it
      const invoiceData = { ...pData, invoiceType: 'PURCHASE_ORDER', invoiceTitle: 'PO INVOICE' };
...
export async function generateInvoicePDFWithDesignAction(invoiceData: any) {
  try {
    // 1. Fetch Invoice Design Settings
    const designPromise = ssrInvoiceDesignAPI.get().catch(err => {
      console.warn('Failed to fetch invoice design, falling back to default:', err.message);
      return { status: 404, data: null };
    });
    ...
    console.error('Generate invoice PDF with design error:', error);
    return { success: false, error: `Failed to generate invoice PDF: ${error instanceof Error ? error.message : String(error)}` };
  }
}
...
export async function createSalesReturnAction(data: {
  ...
  try {
    const response = await ssrSalesReturnAPI.create(data);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
...
// Sales Return: update
export async function updateSalesReturnAction(id: string, data: Record<string, unknown>) {
  try {
    const response = await ssrSalesReturnAPI.update(id, data);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
...
export async function deleteSalesReturnAction(id: string) {
  try {
    const response = await ssrSalesReturnAPI.delete(id);
    if (response.status === 200 || response.status === 204) {
      return { success: true };
    }
...
// Sales Return: change status
export async function changeSalesReturnStatusAction(id: string, data: { status: string }) {
  try {
    const response = await ssrSalesReturnAPI.changeStatus(id, data);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to change sales return status' };
  } catch (error) {
    console.error('Change sales return status error:', error);
    return { success: false, error: 'Failed to change sales return status' };
  }
}

// Sales Return: bulk get selected
export async function bulkGetSelectedSalesReturnsAction(data: { ids: string[] }) {
  try {
    const response = await ssrSalesReturnAPI.bulkGetSelected(data);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to fetch selected sales returns' };
  } catch (error) {
    console.error('Bulk get selected sales returns error:', error);
    return { success: false, error: 'Failed to fetch selected sales returns' };
  }
}

// Sales Return: bulk get all for download
export async function bulkGetSalesReturnsAction(filterData: SearchParamsTypes.DownloadSearchParams) {
  try {
    const response = await ssrSalesReturnAPI.bulkAllDownload(filterData);
    if (response.status === 200 || response.status === 201) {
      return { success: true, data: response.data };
    }
    return { success: false, error: 'Failed to get sales returns' };
  } catch (error) {
    console.error('Bulk get sales returns error:', error);
    return { success: false, error: 'Failed to get sales returns' };
  }
}
