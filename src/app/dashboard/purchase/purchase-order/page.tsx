...
import PurchaseOrderManagement from "@/components/admin/purchase/PurchaseOrderManagement";
...
export default async function PurchaseOrderPage({
    ...
    // Parallel fetch for info
    const [purchaseOrdersRes, initialFormRes] = await Promise.all([
        ServerActions.ServerApilib.ssrPurchaseOrderAPI.getAll(page, limit, search, status, all),
        ServerActions.ServerApilib.ssrPurchaseOrderAPI.getInitialForm()
    ]);
    ...
    return (
        <PageGuard permissionKey="purchase.order">
