...
export default async function DashboardInventoryProductsPage({
  ...
  const productIntialData = await ServerActions.ServerApilib.ssrProductAPI.getInitalProductData();
  console.log("Product inital data : ", productIntialData);
  ...
  const productsResult = await ServerActions.ServerApilib.ssrProductAPI.getAll(page, limit, search, isActive, categoryId);
