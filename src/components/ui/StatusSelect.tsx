...
const StatusSelect = ({
    ...
    const statusColors: Record<string, string> = {
        Draft: "bg-gray-100 text-gray-800 border-gray-200 dark:bg-gray-900/30 dark:text-gray-200 dark:border-gray-800",
        Approved: "bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-900/30 dark:text-blue-200 dark:border-blue-800",
        Billed: "bg-purple-100 text-purple-800 border-purple-200 dark:bg-purple-900/30 dark:text-purple-200 dark:border-purple-800",
        Cancelled: "bg-red-100 text-red-800 border-red-200 dark:bg-red-900/30 dark:text-red-200 dark:border-red-800",
    };

    // Available options based on current purchase order status
                ...
                <>
                    ...
                    >
                        {availableOptions.map((option) => (
                            ...
                            >
                                <span className={`w-2 h-2 rounded-full ${option === 'Draft' ? 'bg-gray-500' :
                                    option === 'Approved' ? 'bg-blue-500' :
                                        option === 'Billed' ? 'bg-purple-500' :
                                            'bg-red-500'
                                    }`} />
                                {option}
                            </button>
