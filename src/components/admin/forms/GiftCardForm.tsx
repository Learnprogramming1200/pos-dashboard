...
const GiftCardForm = ({ onSubmit, giftCard }: GiftCardFormProps) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      sendSms: giftCard?.options?.sendSms ?? false,
      sendWhatsapp: giftCard?.options?.sendWhatsapp ?? false,
    },
  });
  ...
  const onSubmitForm = (data: FormData) => {
    ...
    onSubmit({
      ...
      options: { sendEmail: data.sendMail, sendSms: data.sendSms, sendWhatsapp: data.sendWhatsapp },
      ...
      <div className="p-4 sm:p-5 md:p-6 lg:p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="col-span-1">
              <WebComponents.UiComponents.UiWebComponents.FormLabel htmlFor="send-sms-toggle">
                Send in SMS
              </WebComponents.UiComponents.UiWebComponents.FormLabel>
              <Controller
                name="sendSms"
                    ...
                    <div className="h-[44px] w-full rounded-[4px] border-[0.6px] border-[#D8D9D9] dark:border-[#616161] bg-textMain2 dark:bg-[#1B1B1B]">
                      <div className="flex items-center justify-between px-3 sm:px-4 py-[10px]">
                        ...
                        <WebComponents.UiComponents.UiWebComponents.Switch
                          ...
                          checked={value}
                          onCheckedChange={onChange}
                          aria-label="Toggle send gift card in sms"
                        />
                      </div>
                    </div>
                  </>
            ...
            {/* Send in Whatsapp */}
            <div className="col-span-1">
              <WebComponents.UiComponents.UiWebComponents.FormLabel htmlFor="send-whatsapp-toggle">
                Send in Whatsapp
              </WebComponents.UiComponents.UiWebComponents.FormLabel>
              <Controller
                name="sendWhatsapp"
                  ...
                  <>
                    <div className="h-[44px] w-full rounded-[4px] border-[0.6px] border-[#D8D9D9] dark:border-[#616161] bg-textMain2 dark:bg-[#1B1B1B]">
                      <div className="flex items-center justify-between px-3 sm:px-4 py-[10px]">
                        ...
                        <WebComponents.UiComponents.UiWebComponents.Switch
                          id="send-whatsapp-toggle"
                          checked={value}
                          onCheckedChange={onChange}
                          aria-label="Toggle send gift card in whatsapp"
                        />
                      </div>
                    </div>
                  </>
