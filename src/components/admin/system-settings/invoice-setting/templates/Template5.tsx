    ...
    >
      ...
      <div className={`${
        ...
        <div className={`flex flex-col gap-2 ${
            ...
            design?.logoPosition === 'right' ? 'items-end text-right max-w-[60%]' : 
            'items-start text-left max-w-[60%]'
        }`}>
        ...
        <div className={`${
          ...
          <h2 style={{ ...typography.invoiceTitle, fontSize: '2em', fontWeight: 700, textTransform: 'uppercase', color: colors.secondary }}>
            {data.invoiceTitle}
          </h2>
          <h3 className="whitespace-nowrap mt-2" style={{ ...typography.invoiceTitle, fontSize: '1.2em', color: colors.headings }}>
            {data.invoiceNumber}
          </h3>
