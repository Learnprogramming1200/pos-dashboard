...
import { footerLinkSchema } from "@/app/validation/ValidationSchema";

type FormData = Yup.InferType<typeof footerLinkSchema>;
const FooterFormModel = ({
    title,
    onClose,
    onSubmit,
    ...
    const {
        ...
        resolver: yupResolver(footerLinkSchema),
        defaultValues: {
            ...
            <div className="bg-white dark:bg-darkFilterbar w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-lg p-4 sm:p-6 shadow-xl relative">
                ...
                <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
                    <div className="space-y-6">
                        {/* Title */}
                        <div>
                            <WebComponents.UiComponents.UiWebComponents.FormLabel htmlFor="footer-link-title">
                        ...
                        {/* Description */}
                        <div>
                            <WebComponents.UiComponents.UiWebComponents.FormLabel htmlFor="footer-link-description">
                                ...
                                render={({ field, fieldState }) => (
                                    <>
                                        <WebComponents.UiComponents.UiWebComponents.RichTextEditor
                                            ...
                                            placeholder="Enter description for this footer link..."
                                            height={200}
                                            className="mt-1"
                                        />
                                        {fieldState.error && (
                        ...
                        {/* Status */}
                        <div>
                            <WebComponents.UiComponents.UiWebComponents.FormLabel htmlFor="footer-link-status-toggle">
                    ...
                    <div className="flex flex-col sm:flex-row justify-end gap-3 mt-6">
                        ...
                        <WebComponents.UiComponents.UiWebComponents.Button
                            variant="save"
                            type="submit"
                            disabled={footerLinkLoading}
                        >
                            {footerLinkLoading ? "Saving..." : Constants.superadminConstants.save}
                        </WebComponents.UiComponents.UiWebComponents.Button>
                    </div>
                </form>
            </div>
...
export default FooterFormModel;
